...
/**
 * A resource injector that checks for {@link jakarta.inject.Inject} annotated fields and setter methods to inject
 * resources. If a field is annotated with {@link jakarta.inject.Inject}, a Resource of the type of that field is injected
 * into it, if present. If a method is annotated with {@link jakarta.inject.Inject}, the method is invoked with a Resource
